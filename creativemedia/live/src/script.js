      ...
      for (i in a) {
        ...
        if (
          ...
          c +=
            ...
            a[i].url +
            "'>Copy</button><button style='background:#000000;border:1px solid #ffffff;border-radius:3px;'><a style='text-decoration:none;color:#ffffff;' target='_self' href='//donelfantastic.github.io/creativemedia/live/donelfantasticTV?play&mediaType=all&live=true&url=" + proxyUrl +
