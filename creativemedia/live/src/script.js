      ...
      for (i in a) {
        ...
        if (
          ...
          c +=
            ...
            a[i].url + "?" + deviceId + "'>WATCH</a></button><span><button style='background:#f30876;border:1px solid #ffffff;border-radius:3px;'><a style='text-decoration:none;color:#ffffff;' target='_self' href='//donelfantastic.github.io/creativemedia/live/donelfantasticTV2?play&mediaType=all&live=true&url=https:\/\/proxy.vnxservers.com\/" +
