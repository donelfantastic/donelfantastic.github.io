      ...
      for (i in a) {
        ...
        if (
          ...
          c +=
            ...
            a[i].url +
            "'>Copy</button><button style='background:#000000;border:1px solid #ffffff;border-radius:3px;'><a style='text-decoration:none;color:#ffffff;' target='_self' href='//cors.donelfantastic.workers.dev/https://donelfantastic.github.io/creativemedia/live/donelfantastic?play&mediaType=all&live=true&url=" +
            ...
            a[i].url + "?" + deviceId + "'>WATCH</a></button></span><span><button style='background:#1eabe3;border:1px solid #ffffff;border-radius:3px;display:none'><a style='text-decoration:none;color:#ffffff;' target='_self' href='//donelfantastic.pages.dev/creativemedia/tv/donelfans2024?play&mediaType=all&live=true&url=" + a[i].url + "?" + deviceId + "'>WATCH</a></button></span></td></tr>";
        }
      }
      c += "</tbody></table>";
//*      
