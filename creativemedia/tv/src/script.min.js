    ...
    success: function (a) {
      ...
      for (i in a) {
        ...
        if (
          ...
          output +=
            "<tr><td><center><img width='48' src='" +
            a[i].logo +
            "'/></center></td><td>" +
            a[i].name +
            "</td><td><button class='btn'><a class='open-video' href='" +
            Nella +
            Dory +
            a[i].url +
            "'>WATCH</a></button></td></tr>";
        }
      }
      output += "</tbody></table></br>";
          ...
          output +=
            ...
            "'/></center></td><td>" +
            a[i].name +
            "</td><td><button style='background:#000000;border:1px solid #ffffff;border-radius:3px;'><a class='open-video' href='" +
            Nella +
            Dory +
            a[i].url +
            "'>WATCH</a></button><span><button style='background:#f30876;border:1px solid #ffffff;border-radius:3px;'><a style='text-decoration:none;color:#ffffff;' target='_self' href='//donelfantastic.pages.dev/creativemedia/tv/donelfans2023?play&mediaType=all&live=true&url=" +
