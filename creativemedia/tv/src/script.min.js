window.addEventListener("load", function () {
  ...
  $.ajax({
    ...
    success: function (a) {
      ...
      var output = "";
      output +=
        "<br><table id='myTable' class='display'><thead><tr><th class='th-sm'>LOGO</th><th class='th-sm'>CHANNEL</th><th class='th-sm'>URL</th></thead><tbody>";
      var i, j, k, l;
      for (i in a) {
