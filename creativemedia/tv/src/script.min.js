window.addEventListener("load", function () {
  ...
  $.ajax({
    ...
    success: function (a) {
      ...
      var output = "";
      output +=
        "<br><table id='myTable' class='display'><thead><tr><th class='th-sm' style='text-align:center;'>LOGO</th><th class='th-sm'>CHANNELS</th><th class='th-sm' style='text-align:center;'>LIVE</th></thead><tbody>";
      var i, j, k, l;
      for (i in a) {
