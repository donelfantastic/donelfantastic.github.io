      ...
      for (i in a) {
        ...
        if (
          ...
          c +=
            ...
            a[i].url +
            "'>Copy</button><button style='background:#000000;border:1px solid #ffffff;border-radius:3px;'><a style='text-decoration:none;color:#ffffff;' target='blank' href='//donelfantastic.github.io/creativemedia/tv/donelfans2022?play&mediaType=all&live=true&url=https://proxy.vnxservers.com/" +
            a[i].url + "?" + deviceId + "'>WATCH</a></button><span><button style='background:#f30876;border:1px solid #ffffff;border-radius:3px;'><a style='text-decoration:none;color:#ffffff;' target='blank' href='//donelfantastic.pages.dev/creativemedia/tv/donelfans2023?play&mediaType=all&live=true&url=" +
