...
player.eme();
const keyOptions = {
  "com.widevine.alpha":"https://cors-proxy.cluster.fun/https://mrpw.ptmnc01.verspective.net/?deviceId=OTQyZjJiZTktNTk1Yi0zYjdhLWFhNWItY2NmNWJhYTAzZTNh"
}
      ...
      [
        {
          ...
          options: {
            serverURL:
             "https://cors-proxy.cluster.fun/https://mrpw.ptmnc01.verspective.net:443/?deviceId=OTQyZjJiZTktNTk1Yi0zYjdhLWFhNWItY2NmNWJhYTAzZTNh"
          }
        }, 
        {
...
player.playlist([
    ...
    sources: [
      {
        ...
        src:"https://donelfantastic.github.io/creativemedia/local/sctvID.m3u8",
        type: "application/dash+xml"
        //keySystemOptions: keySystemOptions
      }
    ],
    ...
    sources: [
      {
        ...
        src:
          "https://donelfantastic.github.io/creativemedia/local/indosiarID.m3u8",
  ...
  },
  {
    sources: [
      {
        src: "https://cempedak-live-cdn.mncnow.id/live/eds/ANTV/sa_dash_vmx/ANTV.mpd",
        type: "application/dash+xml", 
        keySystemOptions: keySystemOptions
      }
    ],
  ...
  },
  {
    sources: [
      {
        src: "https://cempedak-live-cdn.mncnow.id/live/eds/RTV/sa_dash_vmx/RTV.mpd",
        type: "application/dash+xml",
        keySystemOptions: keySystemOptions
      }
    ],
  ...
  },
  {
    sources: [
      {
        src:
          "https://cempedak-live-cdn.mncnow.id/live/eds/HBOFamily2/sa_dash_vmx/HBOFamily2.mpd",
        type: "application/dash+xml",
        keySystemOptions: keySystemOptions
      }
    ],
