...
window.addEventListener("load", function () {
  var cukuRukuk = "https://donelfantastic.github.io/live/src/latest/manifest.json";
    ...
    success: function (a) {
      ...
      for (i in a) {
        ...
        if (
          ...
          var doNel = "https://donelfantastic.github.io:443/mn/embed/bitmuv/?live&url=";
          ...
          output += "<tr><td><center><img width='64' src='" + a[i].logo + "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><td><center><button class='btn'><a class='open-video' style='text-decoration:none;' href='" + doNel + a[i].url + "?" + deviceId + "'>WATCH NOW</a></button></center></td></tr>";
        }
      }
      output += "</tbody></table>";
