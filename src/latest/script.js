    ...
    success: function (a) {
      ...
      for (i in a) {
        ...
        if (
          ...
          output += "<tr><td><center><img width='64' src='" + a[i].logo + "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><td><center><button style='background:#000000;border:1px solid #ffffff;border-radius:3px;'><a class='open-video' style='text-decoration:none;' href='" + Dory + a[i].url + "?" + deviceId + "'>WATCH</a></button><span><button style='background:#f30876;border:1px solid #ffffff;border-radius:3px;display:none;'><a style='text-decoration:none;color:#ffffff;display:none' target='_self' href='//donelfantastic.pages.dev/creativemedia/tv/donelfans2023?play&mediaType=all&live=true&url=" + a[i].url + "?" + deviceId + "'>WATCH</a></button></span><span><button style='background:#1eabe3;border:1px solid #ffffff;border-radius:3px;display:none;'><a style='text-decoration:none;color:#ffffff;display:none;' target='_self' href='//donelfantastic.pages.dev/creativemedia/tv/donelfans2024?play&mediaType=all&live=true&url=" + a[i].url + "?" + deviceId + "'>WATCH</a></button></span></center></td></tr>";
        }
      }
      output += "</tbody></table>";
