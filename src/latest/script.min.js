    ...
    success: function (a) {
      ...
      for (i in a) {
        ...
        if (
          ...
          output +=
            "<tr><td><center><img width='64' src='" + a[i].logo+ "'/></center></td><td>" + a[i].name + "</td><td><center><button class='btn'><a class='open-video' href='" + Me + a[i].url + "'>WATCH NOW 1</a></button><span><button class='btn'><a class='open-video' href='" + We + a[i].url + "'>WATCH NOW 2</a></button></span></center></td></tr>";
        }
      }
      output += "</tbody></table>";
