    ...
    success: function (a) {
      ...
      for (i in a) {
        ...
        if (
          ...
          output += "<tr><td><center><img width='64' src='" + a[i].logo + "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><td><center><button class='btn'><a class='open-video' style='text-decoration:none;' href='" + DoryHarsa + a[i].url + "?" + deviceId + "'>WATCH NOW 1</a></button></td><td><button class='btn'><a class='open-video' style='text-decoration:none;' href='" + NellaKharisma + a[i].url + "?" + deviceId + "'>WATCH NOW 2</a></button></center></td></tr>";
