    ...
    success: function (a) {
      ...
      for (i in a) {
        ...
        if (
          ...
          var Us ="https://murid-nakal.github.io/mn/embed/?live&url=";
          var We ="https://donelfantastic.github.io/mn/embed/shoko/?live&url=";
          
          //output += "<tr><td><center><img width='64' src='" + a[i].logo + "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><td><center><a class='open-video' style='text-decoration:none;' href='" + DoryHarsa + a[i].url + "?" + deviceId + "'><img src='//donelfantastic.github.io/assets/watchnow2.png' style='width:64px;height:auto;'/></a><span><a class='open-video' style='text-decoration:none;' href='" + NellaKharisma + a[i].url + "?" + deviceId + "'><img src='//donelfantastic.github.io/assets/watchnow2.png' style='width:64px;height:auto;'/></a></span></center></td></tr>";
          
          output += "<tr><td><center><img width='64' src='" + a[i].logo+ "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><td><center><button class='btn'><a class='open-video' href='" + Me + a[i].url + "'>WATCH NOW 1</a></button><span><button class='btn'><a class='open-video' href='" + We + a[i].url + "'>WATCH NOW 2</a></button></span></center></td></tr>";
        }
      }
      output += "</tbody></table>";
