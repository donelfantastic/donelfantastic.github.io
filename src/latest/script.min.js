    ...
    success: function (a) {
      ...
      for (i in a) {
        ...
        if (
          ...
          output += "<tr><td><center><img width='64' src='" + a[i].logo + "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><td><center><a class='open-video' style='text-decoration:none;' href='" + Us + a[i].url + "?" + deviceId + "'><img src='//donelfantastic.github.io/assets/watchnow2.png' style='width:64px;height:auto;'/></a><span><a class='open-video' style='text-decoration:none;' href='" + We + a[i].url + "?" + deviceId + "'><img src='//donelfantastic.github.io/assets/watchnow2.png' style='width:64px;height:auto;'/></a></span></center></td></tr>";
