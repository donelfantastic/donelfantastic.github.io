...
window.addEventListener("load", function () {
  var cukuRukuk = "30september2023.json";
  var api ="api/static/web/v1/24022024";
  var txt = ".json";
  ...
  $.ajax({
    type: "GET",
    url: "//donelfantastic.github.io/" + api + ".json", 
    success: function (a) {
      var b = 0;
      var output = "";
      output +=
      ...
      for (i in a) {
        ...
        if (
          ...
          var DoryHarsa = "https://donelfantastic.github.io:443/mn/embed/clopprCK/?live&url=";
          var NellaKharisma = "https://donelfantastic.github.io:443/mn/embed/shoko/?live&url=";
          var deviceId = "deviceId=YzM0NDA0MTItMGYyMC0zNGQ0LTliMjMtNDY4MjE1ZjA5NmZj";   
          //output += "<tr><td><center><img width='64' src='" + a[i].logo + "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><td><center><a class='open-video' style='text-decoration:none;' href='" + DoryHarsa + a[i].url + "?" + deviceId + "'><img src='//donelfantastic.github.io/assets/watchnow2.png' style='width:64px;height:auto;'/></a></td><span><td><a class='open-video' style='text-decoration:none;' href='" + NellaKharisma + a[i].url + "?" + deviceId + "'><img src='//donelfantastic.github.io/assets/watchnow2.png' style='width:64px;height:auto;'/></a></span></td></center></td></tr>";
          
          //output += "<tr><td><center><img width='64' src='" + a[i].logo + "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><center><td class='open-video' style='text-decoration:none;' href='" + DoryHarsa + a[i].url + "?" + deviceId + "'><img src='//donelfantastic.github.io/assets/watchnow2.png' style='width:64px;height:auto;'/></a></td><span><td class='open-video' style='text-decoration:none;' href='" + NellaKharisma + a[i].url + "?" + deviceId + "'><img src='//donelfantastic.github.io/assets/watchnow2.png' style='width:64px;height:auto;'/></a></td></center></span></tr>";
          output += "<tr><td><center><img width='64' src='" + a[i].logo + "'/></center></td><td>" + a[i].name + "</td><td style='display:none;'>" + d + "</td><td><center><button class='btn'><a class='open-video' style='text-decoration:none;' href='" + DoryHarsa + a[i].url + "?" + deviceId + "'>WATCH NOW 1</a></button></td><span><td><button class='btn'><a class='open-video' style='text-decoration:none;' href='" + NellaKharisma + a[i].url + "?" + deviceId + "'>WATCH NOW 2</a></button></td></span></center></td></tr>";
